...
from utils import rot6d_to_rotmat
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, shape_dim, app_dim, num_classes=1000, zero_init_residual=False,
...
def _resnet(arch, block, layers, pretrained, progress, shape_dim, app_dim, **kwargs):
    model = ResNet(block, layers, shape_dim, app_dim, **kwargs).cuda()
    if pretrained:
